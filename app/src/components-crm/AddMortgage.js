...
export default class AddMortgage extends Component {
    constructor(props) {
        super(props);
        ...
        this.saveMortgage = this.saveMortgage.bind(this);
        this.newMortgage = this.newMortgage.bind(this);
    ...
    saveMortgage() {
        const data = {
            ...
            contributionPercent: this.state.contributionPercent,
        ...
        MortgageDataService.create(data)
            .then(response => {
                this.setState({
                    id: response.data.id,
                    ...
                    contributionPercent: response.data.contributionPercent,
                ...
                <div className={'container'}>
                    <div className="submit-form">
                        {this.state.submitted ? (
                            <div>
                                <h4>Nowa oferta kredytu hipotecznego została zapisana</h4>
                                <Link
                                    to={{
                            ...
                            <div>
                                <div className="form-group">
                                    <h3>Dodawanie nowej oferty hipotecznej</h3>
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        ...
                                        required
                                        value={this.state.contributionPercent}
                                ...
                                <button onClick={this.saveMortgage} className="btn btn-success">
                                    Zapisz
                                </button>
                            </div>
                        )}
